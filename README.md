...
Бывает полезно получить информацию о подключении к ЕСИА (адрес хоста, сертификаты и т.д.) вне `IEsiaRestService`.
...
Сертификаты среды доступны через свойство `EsiaCertificates`: там лежат все известные сертификаты ЕСИА
(прошлые, текущий и, если он уже известен, будущий), и любым из них может быть подписан маркер доступа.
Свойство `EsiaCertificate` (один сертификат) устарело и будет удалено в следующей мажорной версии.
